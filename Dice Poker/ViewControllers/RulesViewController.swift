...
class RulesViewController: UIViewController {
    ...
    func attributedText() -> NSAttributedString {
        ...
        attributedString.addAttributes(boldFontAttribute, range: string.range(of: "Five of a Kind"))
        attributedString.addAttributes(blueFontAttribute, range: string.range(of: "Five of a Kind"))
